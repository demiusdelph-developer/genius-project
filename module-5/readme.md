...
Специфічність це вага селектора, тобто правило може бути вказане як за допомогою одного селектора так і декількох
Якщо говорити про вагу селекторів то їх визначення є наступним
***inline*** - 1000
***id*** - 100
***class*** - 10
***інші*** - 1
тобто теги з рядковими стилями які пишуться в самому html мають найбільшу вагу, по ідентифікатору стилі мають вагу 100 по класу 10 а інші 1
Якщо застосувати комбінатори то стилі можна перебити але і при використанні комбінаторів якщо вага не перевищить початкове правило  то застосується початкове
